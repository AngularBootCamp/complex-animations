# Angular Boot Camp example: complex-animations
...
**[StackBlitz for complex-animations](https://stackblitz.io/github/AngularBootCamp/complex-animations)**

Alternatively, you can clone the repository locally to run the example:

```
git clone git@github.com:AngularBootCamp/complex-animations.git
cd complex-animations
npm install
npm start
```
